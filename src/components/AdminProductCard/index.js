...
export default function AdminProductCard(props) {
  ...
  return (
    <div className="card adminProductCard__card">
      <div className="card-image adminProductCard__image">
      ...
      <div className="change-img-container">
        <button
          ...
          onClick={() => props.imageWidget(props.id)}
        >
          Change Image
        </button>
      </div>
      <div className="card-content">
        ...
        <div className="product-info-without-name">
          ...
          <div className="product-btns">
            <button
              className="btn product-update-btn"
              onClick={() => props.handleUpdateBtnClick(props.id)}
            >
              Update
            </button>
            <button
              className="btn product-delete-btn"
              onClick={() => props.handleProductDelete(props.id)}
            >
              Delete
            </button>
          </div>
